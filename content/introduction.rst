...
This manual is intended for use by OTRS administrators. The chapters describe the administration of the OTRS software. The administrator interface is available in the *Admin* menu item of the main menu when logged in as an administrator. Administrators are users, who are member of the *admin* group.
